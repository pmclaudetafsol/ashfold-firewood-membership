...
>(({ className, children, invalid, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-md border bg-card px-3 py-2 text-sm',
      'text-foreground [&>span]:line-clamp-1 [&>span]:text-left',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'outline-none focus:bg-primary-muted focus:text-primary',
